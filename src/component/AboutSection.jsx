    ...
    return <section id="about" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="space-y-6">
                ...
                <a href="/GersonResume2025.pdf" target="_blank" download="GersonResume2025.pdf" rel="noopener noreferrer" className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-200">
                    Download CV
                </a>
                </div>
            </div>
